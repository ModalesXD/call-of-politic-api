...
export class EventsController {
    ...
    @Get(':id')
    async getEventById(@Param('id', ParseIntPipe) id: number): Promise<GetEventDto> {
    ...
    @Delete(':id')
    async deleteEvent(@Param('id', ParseIntPipe) id: number): Promise<{ message: string }> {
    ...
    @Patch(':id')
    async updateEvent(@Param('id', ParseIntPipe) id: number, @Body() data: CreateEventDto): Promise<GetEventDto> {
